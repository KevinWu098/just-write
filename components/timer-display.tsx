...
export function TimerDisplay({ duration, isRunning, onTimerEnd }: TimerDisplayProps) {
  ...
  return (
    <div className="flex items-center gap-3">
      <div className={cn("relative w-10 h-10", isResuming && "animate-pulse")}>
        <svg
          className={cn("w-10 h-10 -rotate-90 transition-all ease-in-out", isResuming ? "duration-1000" : "duration-1000")}
          viewBox="0 0 36 36"
        >
        ...
        >
          <div className="w-1 h-3 bg-accent rounded-sm mr-0.5" />
